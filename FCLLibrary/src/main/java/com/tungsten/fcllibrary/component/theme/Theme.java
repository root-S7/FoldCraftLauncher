...
public class Theme {
    ...
    public static Theme getTheme(Context context) {
        ...
        int color = sharedPreferences.getInt("theme_color", ThemeEngine.autoWallpaperColor(context, FCLPath.GENERAL_SETTING.getProperty("default-theme-second-color", "#7797CF")));
